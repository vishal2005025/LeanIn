...
$(function () {
  ...
  if ($("#barChart").length) {
    ...
    const data1 = {
      ...
      datasets: [{
        label: '',
        data: [18, 12, 6, 9, 12, 3, 9, 4, 2, 5, 8, 12, 4],
        backgroundColor: [
          'rgba(255, 26, 104, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(255, 206, 86, 0.2)',
  ...
  if ($("#lineChart").length) {
    ...
    const dataline = {
      ...
      datasets: [{
        label: '',
        data: [18, 12, 6, 9, 12, 3, 9, 10, 5, 11, 12, 6],
        backgroundColor: [
          'rgba(255, 26, 104, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(255, 206, 86, 0.2)',
  ...
  if ($("#doughnutChart").length) {
    ...
    const datadonut = {
      ...
      datasets: [{
        ...
        data: [18, 12, 6, 9, 12, 3, 9, 4, 7, 9, 15, 12],
        backgroundColor: [
          'rgba(255, 26, 104, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(255, 206, 86, 0.2)',
  ...
  if ($("#pieChart").length) {
    ...
    const datapiee = {
      ...
      datasets: [{
        label: '',
        data: [18, 12, 6, 9, 12, 3, 9, 4, 2, 7, 5, 8],
        backgroundColor: [
          'rgba(255, 26, 104, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(255, 206, 86, 0.2)',
  ...
  if ($("#areaChart").length) {
    ...
    const dataareao = {
      ...
      datasets: [{
        label: '',
        data: [18, 12, 6, 9, 12, 3, 9, ,2, 7, 10, 4],
        backgroundColor: [
          'rgba(255, 26, 104, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(255, 206, 86, 0.2)',
  ...
  if ($("#scatterChart").length) {
    ...
    const datardr = {
      labels:  [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021,2022, 2023],
      datasets: [{
        label: 'Year vs Inguries',
        data: [18, 12, 6, 9, 12, 3, 9, 5 , 2, 10, 6, 4],
        backgroundColor: [
          'rgba(255, 26, 104, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(255, 206, 86, 0.2)',
